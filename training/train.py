...
from configs.train_config import get_default_config, get_quick_test_config
...
def main():
    ...
    parser.add_argument('--quick-test', action='store_true',
                        help='Use quick test config (small batches, few steps)')
    
    # Paths
    parser.add_argument('--train-data', type=str, default='./data/tokenized/train.npy',
                        help='Path to training data')
    parser.add_argument('--val-data', type=str, default='./data/tokenized/val.npy',
