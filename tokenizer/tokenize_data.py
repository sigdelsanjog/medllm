...
def main():
    parser = argparse.ArgumentParser(
        description="Tokenize MedQuAD dataset with trained tokenizer"
    )
    parser.add_argument(
        '--input-file',
        type=str,
    ...
    truncated_pct = (np.array([l for l in stats.values() if isinstance(l, (int, float))]) > args.max_length).sum()
